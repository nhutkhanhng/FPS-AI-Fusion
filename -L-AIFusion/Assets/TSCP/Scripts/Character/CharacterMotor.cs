...
namespace CoverShooter
{
    ...
    /// There is an IK (inverse-kinematics) system that handles aiming and recoil. It can be configured manually but for ease of use there is a button to set it up automatically inside the rCharacterMotor inspector. It is recommended to reduce the amount of bones used by IK on non-player characters for performance reasons.
    ...
    public class rCharacterMotor : ICharacterMotor
    {
        #region Properties
        ...
        internal static Dictionary<Animator, rCharacterMotor> animatorToMotorMap = new Dictionary<Animator, rCharacterMotor>();
