...
//            var aimingAffectsLeftHand = (gun != null && gun.Type != EHitType.Pistol) || _motor.EquippedWeapon.Shield == null;
...
//        private void updateLeftHandIntensity(ConvertWeapon gun)
//        {
//            if (_motor.IsGettingHit)
//            {
//                _leftHandAimIntensity = 0;
...
//            {
//                if (gun != null && gun.Type == EHitType.Pistol)
//                {
...
//            var gunComponent = transform.GetComponent<ConvertWeapon>();
...
//        {
//            var leftGun = left.Weapon.GetComponent<ConvertWeapon>();
//            var rightGun = right.Weapon.GetComponent<ConvertWeapon>();
...
//            //{
//            //    var gun = weapon.Weapon.GetComponent<ConvertWeapon>();
